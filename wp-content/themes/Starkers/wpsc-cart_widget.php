	...
	<table>
		...
		<tfoot>
			<tr class="cart-widget-total">
				<td class="cart-widget-count" id="count"><img id="cart-icon" src="/wp-content/themes/Starkers/images/cart-icon.png">
					<?php printf( _n('(%d)', '(%d)', wpsc_cart_item_count(), 'wpsc'), wpsc_cart_item_count() ); ?>
				</td>
				<td class="sub-t" class="pricedisplay checkout-total" colspan='4'>
...
<?php else: ?>
	...
	<p class="zero">
			<img id="cart-icon" src="/wp-content/themes/Starkers/images/cart-icon.png">&nbsp;(0) Subtotal: $0.00
	</p><!--/zero-->
