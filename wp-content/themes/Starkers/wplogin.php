...
case 'rp' :
	...
	login_header(__('Reset Password'), '<p class="message reset-pass">' . __('Please enter a new 4-digit PIN number.') . '</p>', $errors );
...
<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( site_url( 'wp-login.php?action=resetpass&key=' . urlencode( $_GET['key'] ) . '&login=' . urlencode( $_GET['login'] ), 'login_post' ) ); ?>" method="post">
	...
	<input placeholder="New PIN" name="pass1" id="pass1" class="text-input tel" size="20" value="" autocomplete="off" type="tel" maxlength="4" onkeypress="return isNumberKey(event)"/>
	<input placeholder="Repeat PIN" name="pass2" id="pass2" class="text-input tel" size="20" value="" autocomplete="off" type="tel" maxlength="4" onkeypress="return isNumberKey(event)"/>
	<input type="submit" name="wp-submit" id="reset-btn" value="Sign In" tabindex="100">
</form>
