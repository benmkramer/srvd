    ...
    <div id="jqt">
        ...
        <div id="register" class="pattern">
            ...
            <div class="register-valid">
				<span class="green-check"></span><p>Welcome to Flowtab!</p>
			</div><!--/register-valid-->
            ...
            <div class="form">
				...
				<div class="terms-wrap">Flowtab uses your cell number to text you when your drinks are ready.</div>
			</div><!--/form-->
        </div><!--/register-->
	    ...
	    <div id="about" class="pattern">
			...
			<div id="about-w"><div class="scroller">
	        	<div class="f-line"></div>
	        	<div class="text">
					<p>Flowtab lets you order and pay for your drinks, from anywhere within a bar, right from the comfort of your phone. No more waiting, no more wallets and no more open tabs.</p>
					<h2>Step 1: Browse</h2>
					...
					<p>Your order will be sent to an iPad behind the bar and you will receive a text when your drinks are ready. Just go to the Flowtab pick-up area and grab your drinks, or for table orders just relax and wait for your server.</p><br/>
        ...
        <div id="categories" class="pattern">
            ...
            <div class="wifi-alert">
				<span class="green-wifi"></span><p>Connect to Flowtab's free WiFi!</p>
			</div><!--/wifi-alert-->
    	...
    	<div id="settings" class="pattern">
			...
			<div class="scroll">
                ...
                <div class="welcome">Welcome, <span id="big-name"></span><br/>© 2014 Srvd, Inc. | v1.0</div>
			</div><!--/scroll-->
        </div><!--/settings-->
	    ...
	    <div id="security" class="pattern">
	        ...
	        <div id="security-w"><div class="scroller">
	        	...
	        	<div class="text">
					...
					<h2>Terms of Use</h2>
					<p>The creation and use of a Flowtab account indicates your agreement to comply with our Terms of Use as well as any applicable local laws and regulations. Please visit nick.hesling.com:81/terms for details.</p>
				</div><!--/text-->
	        </div><!--/scroller--></div><!--/wrapper-->
	    </div><!--/security-->
	    ...
	    <div id="affiliate" class="pattern">
        	...
        	<div id="affiliate-w"><div class="scroller">
	        	...
	        	<div class="text">
	        		<div id="aff-true">
		        		<p>Whenever your balance reaches $25, we will send you a deposit via PayPal.<br/><br/><strong>Please verify the email you have on file with Flowtab matches one of your addresses at PayPal.</strong></p>
	        		...
	        		<div id="aff-false">
		        		...
		        		<p>As a Flowtab affiliate, you will receive $5 for each new user who enters your discount promo code at checkout, then 25&#162; for each order after that (for up to one year).<br/><br/>If you refer a new affiliate to Flowtab, you will earn 20% of all the money they make as well.<br/><br/>Click below and one of us will reach out to you.</p>
	    ...
	    <div id="share" class="pattern">
        	...
        	<div class="text">
        		...
        		<p>Have a friend who you think might like Flowtab? Email them a free download link:</p>
        		<a href="mailto:?subject=Check%20out%20Flowtab&body=Flowtab%20lets%20you%20order%20and%20pay%20for%20drinks%20in%20crowded%20nightclubs%20and%20bars%20right%20from%20your%20phone.%0D%0A%0D%0ADownload%20the%20free%20iPhone/Android%20app%20at%20http://flwtb.co/Dwnload%20or%20play%20with%20the%20HTML5%20web%20app%20at%20http://nick.hesling.com:81."><div id="send-text">Send Message</div></a>
	        </div><!--/text-->
	    </div><!--/share-->
